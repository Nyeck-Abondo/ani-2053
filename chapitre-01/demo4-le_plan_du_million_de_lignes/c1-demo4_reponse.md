...
github.com/AlDanial/cloc v 2.10  T=0.22 s (94.3 files/s, 64471.2 lines/s)
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
C/C++ Header                    13           1705           7432           3605
C++                              8            265            451            892
-------------------------------------------------------------------------------
SUM:                            21           1970           7883           4497
-------------------------------------------------------------------------------
```

on observe ici que le nombre de lignes de code est de : **4497**
...
|**Modules**|**Runtime** | **Engine**| **Foundation**|
|-- |-- | --| --|
| `NKFont`| 47511| -------| -------
 `NKRenderer`| 33544 | ------- |-------
`NKRHI`| 26655 | ------- | -------
...
```
                  ...
                  │    │    │            ║                    │                                       │          │             │
               ┌──┴────┴────┴──┐         ║            ┌───────┴───────┐    ┌───────────────┐          │          │     ┌───────┴───────┐        ┌───────────────┐
               │   NKWINDOW    │═ ═══════╝            │     NKFONT    │───►│    NKUI       │          │          │     │     NKSL      │        │    NkAUDIO    │  └───────────────┘                      └───────────────┘    └───────────────┘          │          │     └───────────────┘        └───────────────┘    
                     ▲                                        ▲                    ▲                  │          │               ▲                        ▲
                     │                                        │                    │                  │          │               │                        │
                     │                                        │                    │                  │          │               │                        │
                     │                                        │                    │                  │          │               │                        │
